...
pygame.display.set_caption("Chifwin's great game")

# Load background
BACKGROUND = pygame.image.load("Lab_8\\materials\\AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('Lab_8\\materials\\Enemy.png')
...
class Coins(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.transform.scale(pygame.image.load('Lab_8\\materials\\Coin.png'),
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('Lab_8\\materials\\Player.png')
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound('Lab_8\\materials\\crash.wav').play()
        time.sleep(0.5)
